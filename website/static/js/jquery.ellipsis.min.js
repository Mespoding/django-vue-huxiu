// 自动计算内容宽度（不是字数）截断，并加上省略号，内容不受中英文或符号限制  $(dom).ellipsis({maxWidth:120,maxLine:2});
!function (a) {
    a.fn.ellipsis = function (b) {
        ...
        return b = a.extend(c, b), this.each(function () {
            var c = a(this), d = c.text(), e = d, f = e.length, g = c.height();
            c.text("a");
            var h = parseFloat(c.css("lineHeight"), 10), i = c.height(), j = h > i ? h - i : 0, k = j * (b.row - 1) + i * b.row;
