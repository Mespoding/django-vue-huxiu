...
var nativeShare = function (elementNode, config) {
    ...
    this.share = function (to_app) {
        ...
        if (isucBrowser) {
            ...
            if (to_app == 'QZone') {
                B = "mqqapi://share/to_qzone?src_type=web&version=1&file_type=news&req_type=1&img=" + img + "&image_url=" + img + "&title=" + title + "&description=" + desc + "&desc" + desc + "&url=" + url + "&app_name=" + from;
            ...
            if (typeof(ucweb) != "undefined") {
                ...
                if (typeof(ucbrowser) != "undefined") {
                    ucbrowser.web_share(title, desc, url, to_app, img, "@" + from, img)
                } else {
                }
            }
        } else {
    ...
    for (var i = 0; i < items.length; i++) {
        items[i].onclick = function () {
            ...
            share.url = share.url + $(this).attr('data-f');
            var _this = this;
            setTimeout(function () {
